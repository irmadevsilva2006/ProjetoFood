...
namespace ProjetoFood.Areas.Admin.Controllers
{
    ...
    public class AdminItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ItemId,Nome,DescricaoCurta,DescricaoDetalhada,ImagemUm,Preco,Ativo,Destaque,CategoriaId")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ItemId,Nome,DescricaoCurta,DescricaoDetalhada,ImagemUm,Preco,Ativo,Destaque,CategoriaId")] Item item)
        {
            if (id != item.ItemId)
            {
                return NotFound();
